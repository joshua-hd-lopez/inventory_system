...
//COBOL.SYSIN DD DSN=KC03AB2.AX.COBOL(PRDLOAB2),DISP=SHR
/*
/* DECLARE PDS MEMBER TO STORE LOAD MODULE
//LKED.SYSLMOD DD DSN=KC03AB2.COBOL.LOADLIB(PRDLOAB2),
//    DISP=OLD
/*
//PRDLOAD  EXEC PGM=PRDLOAB2
/*
//STEPLIB  DD DSN=KC03AB2.COBOL.LOADLIB,DISP=SHR
//CMDATA   DD DSN=KC03AB2.AX.PRD.DATA,DISP=SHR
//OUTFILE  DD DSN=KC03AB2.AX.CICS.PRDAB2,DISP=SHR